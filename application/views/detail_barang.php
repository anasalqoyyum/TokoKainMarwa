<div class="container0-fluid">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-4"><img src="<?php echo base_url().'/assets/images/'.$brg->gambar ?>" class="card-img-top"></div>
            <div class="col-md-8">
                <table class="table">
                    <tr>
                        <td>Nama Produk</td>
                    ...
                    <tr>
                    <td>REMINDER</td>
                    <td><strong>Pembelian dihitung dalam hitungan kodi<strong></td>
                    </tr>
                </table>
